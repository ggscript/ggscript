      	...
      	<div className="row">
            <div className="sandColor">
      		...
      		<div className="col-md-3">
      			...
      			<p className="text-center">I am passionate about education and strive to rid the world of problems, regardless of how big or small they may be. On any given weekend you might find me running around the city or curled up in bed, getting lost in a book.</p>
      			<div className="col-md-12 text-center">
