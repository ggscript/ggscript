      	...
      	<div className="row">
            <div className="sandColor">
      		...
      		<div className="col-md-3">
      			...
      			<p className="text-center">I’m passionate about building tools that allow others to learn and explore.  When I’m not coding, I’ll be kitesurfing or playing beach volleyball, or binge watching tv shows if the weather isn’t great for either of the former.</p>
      			<div className="col-md-12 text-center">
